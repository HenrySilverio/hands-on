...
## Prints exigem atenção redobrada

Print de tela de sistema quase sempre carrega dado de cliente: nome no cabeçalho, contrato na
lateral, valor da dívida no meio da regra que interessa. Faça a substituição na **transcrição**,
antes de gravar — a imagem não é gravada, mas o texto que você extraiu dela sim.
